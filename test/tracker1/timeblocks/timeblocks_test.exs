defmodule Tracker1.TimeblocksTest do
  use Tracker1.DataCase
  ...
  describe "timeblocks" do
    ...
    test "create_timeblock/1 with valid data creates a timeblock" do
      ...
      assert timeblock.end == DateTime.from_naive!(~N[2010-04-17T14:00:00Z], "Etc/UTC")
      assert timeblock.start == DateTime.from_naive!(~N[2010-04-17T14:00:00Z], "Etc/UTC")
    end
    ...
    test "update_timeblock/2 with valid data updates the timeblock" do
      ...
      assert timeblock.end == DateTime.from_naive!(~N[2011-05-18T15:01:01Z], "Etc/UTC")
      assert timeblock.start == DateTime.from_naive!(~N[2011-05-18T15:01:01Z], "Etc/UTC")
    end
